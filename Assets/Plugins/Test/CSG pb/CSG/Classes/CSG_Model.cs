...
namespace Parabox.CSG
{
    ...
    public sealed class CSG_Model
    {
        ...
        */
        ...
        //Adaptation for Skinned Meshes in Children
        public CSG_Model(GameObject gameObject)
        {
            Mesh mesh; 
            Material[] materials; 
            ...
            else {  //for the players Hand
                GameObject go = gameObject.GetComponentInChildren<SkinnedMeshRenderer>().gameObject;
                mesh = go.GetComponent<SkinnedMeshRenderer>()?.sharedMesh;
                materials = go.GetComponent<SkinnedMeshRenderer>()?.sharedMaterials;
