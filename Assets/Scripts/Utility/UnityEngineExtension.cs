...
namespace UnityEngine
{
    ...
    public static class UnityEngineExtension
    {
        ...
        /// <summary>
        /// Sets transform as parent from another and scales the child up so the relation keeps the same
        /// </summary>
        /// <param name="transform">child transform</param>
        /// <param name="parent">parent transform</param>
        public static void SetParentUnscaled(this Transform transform, Transform parent)
        {
            Vector3 transformLossyScale = transform.lossyScale;

            transform.parent = parent;
            transform.localScale = transformLossyScale;
        }
    }
}